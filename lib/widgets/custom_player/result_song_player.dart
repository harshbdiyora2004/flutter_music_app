...
class ResultSongPlayer extends StatefulWidget {
  List<Result> resultSongs;
  bool isFav;
  int currentSongIndex;
  ResultSongPlayer({
    Key? key,
    required this.resultSongs,
    required this.isFav,
    required this.currentSongIndex,
  }) : super(key: key);

  @override
  State<ResultSongPlayer> createState() => _LikedSongPlayerState();
}

class _LikedSongPlayerState extends State<ResultSongPlayer> {
  int sliderValue = 0;
  ...
  Future<void> addToFav() async {
    SongApi.songId = widget.resultSongs[widget.currentSongIndex].id;
  ...
  Future<void> removeToFav() async {
    await FavMusic.removeFromFavorites(
        widget.resultSongs[widget.currentSongIndex].id);
  }

  Future<void> toggleFav() async {
    List<Datum> fav = await FavMusic.getFavourite();
    widget.isFav = fav.any((element) =>
        element.id == widget.resultSongs[widget.currentSongIndex].id);
  }
  ...
  void initState() {
    audioPlayer.setUrl(
        widget.resultSongs[widget.currentSongIndex].downloadUrl[2].link);
  ...
  Widget build(BuildContext context) {
    ...
    String inputString = widget.resultSongs[widget.currentSongIndex].duration;
                        ...
                        child: Center(
                          child: Column(
                            children: [
                              ...
                              Text(
                                widget.resultSongs[widget.currentSongIndex].name
                                    .toString(),
                  ...
                  child: AspectRatio(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget
                            .resultSongs[widget.currentSongIndex].image[2].link,
                        fit: BoxFit.cover,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.resultSongs[widget.currentSongIndex]
                                  .primaryArtists
                                  .toString(),
                              maxLines: 2,
                              style: const TextStyle(
                            ...
                            onPressed: () {
                              if (widget.currentSongIndex > 0) {
                                ...
                                audioPlayer.setUrl(widget
                                    .resultSongs[widget.currentSongIndex]
                                    .downloadUrl[2]
                                    .link);
                      ...
                      IconButton(
                        onPressed: () {
                          ...
                          FileDownloader.downloadFile(
                            ...
                            url: widget.resultSongs[widget.currentSongIndex]
                                .downloadUrl[2].link,
                            name: widget
                                .resultSongs[widget.currentSongIndex].name
                                .toString(),
