...
class AlbumSongPlayer extends StatefulWidget {
  ...
  @override
  State<AlbumSongPlayer> createState() => _LikedSongPlayerState();
}

class _LikedSongPlayerState extends State<AlbumSongPlayer> {
  int sliderValue = 0;
  ...
  Future<void> addToFav() async {
    SongApi.songId = widget.albumSongs[widget.currentSongIndex].id;
  ...
  Future<void> removeToFav() async {
    await FavMusic.removeFromFavorites(
        widget.albumSongs[widget.currentSongIndex].id);
  }

  Future<void> toggleFav() async {
    List<Datum> fav = await FavMusic.getFavourite();
    widget.isFav = fav.any((element) =>
        element.id == widget.albumSongs[widget.currentSongIndex].id);
  }
  ...
  void initState() {
    audioPlayer
        .setUrl(widget.albumSongs[widget.currentSongIndex].downloadUrl[2].link);
  ...
  Widget build(BuildContext context) {
    ...
    String inputString = widget.albumSongs[widget.currentSongIndex].duration;
                        ...
                        child: Center(
                          child: Column(
                            children: [
                              ...
                              Text(
                                widget.albumSongs[widget.currentSongIndex].name
                                    .toString(),
                  ...
                  child: AspectRatio(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget
                            .albumSongs[widget.currentSongIndex].image[2].link,
                        fit: BoxFit.cover,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.albumSongs[widget.currentSongIndex]
                                  .primaryArtists
                                  .toString(),
                              maxLines: 2,
                              style: const TextStyle(
                            ...
                            onPressed: () {
                              if (widget.currentSongIndex > 0) {
                                ...
                                audioPlayer.setUrl(widget
                                    .albumSongs[widget.currentSongIndex]
                                    .downloadUrl[2]
                                    .link);
                      ...
                      IconButton(
                        onPressed: () {
                          ...
                          FileDownloader.downloadFile(
                            ...
                            url: widget.albumSongs[widget.currentSongIndex]
                                .downloadUrl[2].link,
                            name: widget
                                .albumSongs[widget.currentSongIndex].name
                                .toString(),
