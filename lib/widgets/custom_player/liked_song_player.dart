...
class LikedSongPlayer extends StatefulWidget {
  List<Datum> dataum;
  ...
  @override
  State<LikedSongPlayer> createState() => _LikedSongPlayerState();
}

class _LikedSongPlayerState extends State<LikedSongPlayer> {
  int sliderValue = 0;
  ...
  void addToFav() async {
    SongApi.songId = widget.dataum[widget.currentSongIndex].id;
    SongDetailsModel songDetailsModel = await SongApi.feachAllData();
    await FavMusic.addToFavourite(songDetailsModel.data[0]);
  }

  void removeToFav() async {
    await FavMusic.removeFromFavorites(
        widget.dataum[widget.currentSongIndex].id);
    widget.dataum.removeAt(widget.currentSongIndex);
  ...
  void toggleFav() async {
    ...
    widget.isFav = fav.any(
        (element) => element.id == widget.dataum[widget.currentSongIndex].id);
  }
  ...
  void initState() {
    audioPlayer
        .setUrl(widget.dataum[widget.currentSongIndex].downloadUrl[2].link);
  ...
  Widget build(BuildContext context) {
    ...
    String inputString = widget.dataum[widget.currentSongIndex].duration;
                        ...
                        child: Center(
                          child: Column(
                            children: [
                              ...
                              Text(
                                widget.dataum[widget.currentSongIndex].name
                                    .toString(),
                  ...
                  child: AspectRatio(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget
                            .dataum[widget.currentSongIndex].image[2].link,
                        fit: BoxFit.cover,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.dataum[widget.currentSongIndex]
                                  .primaryArtists
                                  .toString(),
                              maxLines: 2,
                              style: const TextStyle(
                            ...
                            onPressed: () {
                              if (widget.currentSongIndex > 0) {
                                ...
                                audioPlayer.setUrl(widget
                                    .dataum[widget.currentSongIndex]
                                    .downloadUrl[2]
                                    .link);
                      ...
                      IconButton(
                        onPressed: () {
                          ...
                          FileDownloader.downloadFile(
                            ...
                            url: widget.dataum[widget.currentSongIndex]
                                .downloadUrl[2].link,
                            name: widget.dataum[widget.currentSongIndex].name
                                .toString(),
